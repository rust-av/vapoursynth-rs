...
# Install zimg
git clone --depth 1 --branch release-3.0.6 https://github.com/sekrit-twc/zimg.git
cd zimg
./autogen.sh
...
# Install VapourSynth
git clone --depth 1 --branch R73 https://github.com/vapoursynth/vapoursynth.git vs-dir
cd vs-dir
./autogen.sh
./configure $CONFIGURE_ARGS
sudo make install
